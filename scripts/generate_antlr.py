...
java -jar ~/.local/bin/antlr-{version}-complete.jar -o autogenerated -no-listener -visitor -Dlanguage=Cpp {grammar}Lexer.g4
java -jar ~/.local/bin/antlr-{version}-complete.jar -o autogenerated -no-listener -visitor -Dlanguage=Cpp {grammar}Parser.g4
