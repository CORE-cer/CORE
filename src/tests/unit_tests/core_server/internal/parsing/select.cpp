...
TEST_CASE("Select captures strategy correctly", "[Select, Strategy]") {
  // clang-format off
  REQUIRE(parse_select(create_select_query("ALL", "*")).strategy == Select::Strategy::ALL); // NOLINT
  REQUIRE(parse_select(create_select_query("ANY", "*")).strategy == Select::Strategy::ANY); // NOLINT
  REQUIRE(parse_select(create_select_query("LAST", "*")).strategy == Select::Strategy::LAST); // NOLINT
  REQUIRE(parse_select(create_select_query("MAX", "*")).strategy == Select::Strategy::MAX); // NOLINT
  REQUIRE(parse_select(create_select_query("NEXT", "*")).strategy == Select::Strategy::NEXT); // NOLINT
  REQUIRE(parse_select(create_select_query("STRICT", "*")).strategy == Select::Strategy::STRICT); // NOLINT
  REQUIRE(parse_select(create_select_query("", "*")).strategy == Select::Strategy::DEFAULT); // NOLINT
  // clang-format on
}
