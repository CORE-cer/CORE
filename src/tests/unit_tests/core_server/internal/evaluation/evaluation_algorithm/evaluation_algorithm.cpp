...
TEST_CASE("Evaluation on the example stream of the papers") {
  ...
  REQUIRE(is_the_same_as(output.complex_events[1].events[3], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[1].events[4], 0, "AMZN", 1900));
  REQUIRE(is_the_same_as(output.complex_events[1].events[5], 0, "AMZN", 1900));
  ...
  REQUIRE(is_the_same_as(output.complex_events[1].events[2], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[1].events[3], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[1].events[4], 0, "AMZN", 1920));
  REQUIRE(is_the_same_as(output.complex_events[1].events[5], 0, "AMZN", 1920));

  INFO(output.complex_events[2].to_string());
  REQUIRE(output.complex_events[2].events.size() == 6);
  ...
  REQUIRE(is_the_same_as(output.complex_events[2].events[2], 0, "INTL", 81));
  REQUIRE(is_the_same_as(output.complex_events[2].events[3], 0, "INTL", 81));
  REQUIRE(is_the_same_as(output.complex_events[2].events[4], 0, "AMZN", 1920));
  REQUIRE(is_the_same_as(output.complex_events[2].events[5], 0, "AMZN", 1920));

  INFO(output.complex_events[3].to_string());
  REQUIRE(output.complex_events[3].events.size() == 6);
  ...
  REQUIRE(is_the_same_as(output.complex_events[3].events[1], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[3].events[2], 0, "INTL", 81));
  REQUIRE(is_the_same_as(output.complex_events[3].events[3], 0, "INTL", 81));
  REQUIRE(is_the_same_as(output.complex_events[3].events[4], 0, "AMZN", 1920));
  REQUIRE(is_the_same_as(output.complex_events[3].events[5], 0, "AMZN", 1920));
}
...
TEST_CASE(
  ...
  REQUIRE(is_the_same_as(output.complex_events[1].events[2], 0, "INTL", 81));
  REQUIRE(is_the_same_as(output.complex_events[1].events[3], 0, "INTL", 81));
  REQUIRE(is_the_same_as(output.complex_events[1].events[4], 0, "AMZN", 1920));
  REQUIRE(is_the_same_as(output.complex_events[1].events[5], 0, "AMZN", 1920));
}
...
TEST_CASE("Evaluation of long query") {
  ...
  REQUIRE(output.complex_events[0].events.size() == 18);
  REQUIRE(is_the_same_as(output.complex_events[0].events[0], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[0].events[1], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[0].events[2], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[0].events[3], 0, "INTL", 80));
  ...
  REQUIRE(is_the_same_as(output.complex_events[0].events[7], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[0].events[8], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[0].events[9], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[0].events[10], 0, "AMZN", 1900));
  REQUIRE(is_the_same_as(output.complex_events[0].events[11], 0, "AMZN", 1900));
  REQUIRE(is_the_same_as(output.complex_events[0].events[12], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[0].events[13], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[0].events[14], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[0].events[15], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[0].events[16], 0, "AMZN", 1900));
  REQUIRE(is_the_same_as(output.complex_events[0].events[17], 0, "AMZN", 1900));
...
TEST_CASE(
  ...
  REQUIRE(output.complex_events[1].events.size() == 8);
  REQUIRE(is_the_same_as(output.complex_events[1].events[0], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[1].events[1], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[1].events[2], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[1].events[3], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[1].events[4], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[1].events[5], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[1].events[6], 0, "AMZN", 1900));
  REQUIRE(is_the_same_as(output.complex_events[1].events[7], 0, "AMZN", 1900));

  REQUIRE(output.complex_events[2].events.size() == 6);
  REQUIRE(is_the_same_as(output.complex_events[2].events[0], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[2].events[1], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[2].events[2], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[2].events[3], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[2].events[4], 0, "AMZN", 1900));
  REQUIRE(is_the_same_as(output.complex_events[2].events[5], 0, "AMZN", 1900));

  REQUIRE(output.complex_events[3].events.size() == 6);
  REQUIRE(is_the_same_as(output.complex_events[3].events[0], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[3].events[1], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[3].events[2], 1, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[3].events[3], 1, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[3].events[4], 0, "AMZN", 1900));
  REQUIRE(is_the_same_as(output.complex_events[3].events[5], 0, "AMZN", 1900));

  REQUIRE(output.complex_events[4].events.size() == 8);
  REQUIRE(is_the_same_as(output.complex_events[4].events[0], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[4].events[1], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[4].events[2], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[4].events[3], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[4].events[4], 1, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[4].events[5], 1, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[4].events[6], 0, "AMZN", 1900));
  REQUIRE(is_the_same_as(output.complex_events[4].events[7], 0, "AMZN", 1900));

  REQUIRE(output.complex_events[5].events.size() == 6);
  REQUIRE(is_the_same_as(output.complex_events[5].events[0], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[5].events[1], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[5].events[2], 1, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[5].events[3], 1, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[5].events[4], 0, "AMZN", 1900));
  REQUIRE(is_the_same_as(output.complex_events[5].events[5], 0, "AMZN", 1900));
  ...
  REQUIRE(is_the_same_as(output.complex_events[0].events[1], 0, "MSFT", 105));
  REQUIRE(is_the_same_as(output.complex_events[0].events[2], 0, "INTL", 85));
  REQUIRE(is_the_same_as(output.complex_events[0].events[3], 0, "INTL", 85));
  REQUIRE(is_the_same_as(output.complex_events[0].events[4], 0, "AMZN", 1901));
  REQUIRE(is_the_same_as(output.complex_events[0].events[5], 0, "AMZN", 1901));

  REQUIRE(output.complex_events[1].events.size() == 6);
  REQUIRE(is_the_same_as(output.complex_events[1].events[0], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[1].events[1], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[1].events[2], 0, "INTL", 85));
  REQUIRE(is_the_same_as(output.complex_events[1].events[3], 0, "INTL", 85));
  REQUIRE(is_the_same_as(output.complex_events[1].events[4], 0, "AMZN", 1901));
  REQUIRE(is_the_same_as(output.complex_events[1].events[5], 0, "AMZN", 1901));

  REQUIRE(output.complex_events[2].events.size() == 8);
  REQUIRE(is_the_same_as(output.complex_events[2].events[0], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[2].events[1], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[2].events[2], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[2].events[3], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[2].events[4], 0, "INTL", 85));
  REQUIRE(is_the_same_as(output.complex_events[2].events[5], 0, "INTL", 85));
  REQUIRE(is_the_same_as(output.complex_events[2].events[6], 0, "AMZN", 1901));
  REQUIRE(is_the_same_as(output.complex_events[2].events[7], 0, "AMZN", 1901));

  REQUIRE(output.complex_events[3].events.size() == 6);
  REQUIRE(is_the_same_as(output.complex_events[3].events[0], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[3].events[1], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[3].events[2], 0, "INTL", 85));
  REQUIRE(is_the_same_as(output.complex_events[3].events[3], 0, "INTL", 85));
  REQUIRE(is_the_same_as(output.complex_events[3].events[4], 0, "AMZN", 1901));
  REQUIRE(is_the_same_as(output.complex_events[3].events[5], 0, "AMZN", 1901));

  REQUIRE(output.complex_events[4].events.size() == 6);
  ...
  REQUIRE(is_the_same_as(output.complex_events[4].events[2], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[4].events[3], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[4].events[4], 0, "AMZN", 1901));
  REQUIRE(is_the_same_as(output.complex_events[4].events[5], 0, "AMZN", 1901));

  REQUIRE(output.complex_events[5].events.size() == 8);
  REQUIRE(is_the_same_as(output.complex_events[5].events[0], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[5].events[1], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[5].events[2], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[5].events[3], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[5].events[4], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[5].events[5], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[5].events[6], 0, "AMZN", 1901));
  REQUIRE(is_the_same_as(output.complex_events[5].events[7], 0, "AMZN", 1901));

  REQUIRE(output.complex_events[6].events.size() == 6);
  REQUIRE(is_the_same_as(output.complex_events[6].events[0], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[6].events[1], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[6].events[2], 1, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[6].events[3], 1, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[6].events[4], 0, "AMZN", 1901));
  REQUIRE(is_the_same_as(output.complex_events[6].events[5], 0, "AMZN", 1901));

  REQUIRE(output.complex_events[7].events.size() == 8);
  REQUIRE(is_the_same_as(output.complex_events[7].events[0], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[7].events[1], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[7].events[2], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[7].events[3], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[7].events[4], 1, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[7].events[5], 1, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[7].events[6], 0, "AMZN", 1901));
  REQUIRE(is_the_same_as(output.complex_events[7].events[7], 0, "AMZN", 1901));

  REQUIRE(output.complex_events[8].events.size() == 6);
  REQUIRE(is_the_same_as(output.complex_events[8].events[0], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[8].events[1], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[8].events[2], 1, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[8].events[3], 1, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[8].events[4], 0, "AMZN", 1901));
  REQUIRE(is_the_same_as(output.complex_events[8].events[5], 0, "AMZN", 1901));

  REQUIRE(output.complex_events[9].events.size() == 6);
  REQUIRE(is_the_same_as(output.complex_events[9].events[0], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[9].events[1], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[9].events[2], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[9].events[3], 0, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[9].events[4], 0, "AMZN", 1901));
  REQUIRE(is_the_same_as(output.complex_events[9].events[5], 0, "AMZN", 1901));
}
...
TEST_CASE(
  ...
  REQUIRE(is_the_same_as(output.complex_events[0].events[0], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[0].events[1], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[0].events[2], 1, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[0].events[3], 1, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[0].events[4], 0, "AMZN", 1900));
  REQUIRE(is_the_same_as(output.complex_events[0].events[5], 0, "AMZN", 1900));
  ...
  REQUIRE(is_the_same_as(output.complex_events[1].events[2], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[1].events[3], 0, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[1].events[4], 1, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[1].events[5], 1, "INTL", 80));
  REQUIRE(is_the_same_as(output.complex_events[1].events[6], 0, "AMZN", 1900));
  REQUIRE(is_the_same_as(output.complex_events[1].events[7], 0, "AMZN", 1900));
}
...
TEST_CASE(
  ...
  REQUIRE(is_the_same_as(output.complex_events[0].events[1], 1, "MSFT", 102));

  REQUIRE(output.complex_events[1].events.size() == 4);
  REQUIRE(is_the_same_as(output.complex_events[1].events[0], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[1].events[1], 0, "MSFT", 101));
  REQUIRE(is_the_same_as(output.complex_events[1].events[2], 1, "MSFT", 102));
  REQUIRE(is_the_same_as(output.complex_events[1].events[3], 1, "MSFT", 102));
}
