...
PYBIND11_MODULE(_pycore, m) {
  ...
  py::class_<Types::IntValue, Types::Value, std::shared_ptr<Types::IntValue>>(m,
                                                                              "PyIntValu"
                                                                              "e")
    .def(py::init<int64_t>());

  py::class_<Types::StringValue, Types::Value, std::shared_ptr<Types::StringValue>>(m,
                                                                                    "PySt"
                                                                                    "ring"
                                                                                    "Valu"
                                                                                    "e")
  ...
  py::class_<Types::DoubleValue, Types::Value, std::shared_ptr<Types::DoubleValue>>(m,
                                                                                    "PyDo"
                                                                                    "uble"
                                                                                    "Valu"
                                                                                    "e")
  ...
  py::class_<Types::BoolValue, Types::Value, std::shared_ptr<Types::BoolValue>>(m,
                                                                                "PyBoolVa"
                                                                                "lue")
    .def(py::init<bool>());

  py::class_<Types::DateValue, Types::Value, std::shared_ptr<Types::DateValue>>(m,
                                                                                "PyDateVa"
                                                                                "lue")
  ...
  py::class_<Streamer>(m, "PyStreamer")
    ...
    .def("send_stream",
         py::overload_cast<uint64_t, Types::Event&>(&Streamer::send_stream));

  py::class_<Client>(m, "PyClient")
    .def(py::init<std::string, uint16_t>())
    .def("declare_stream",
         py::overload_cast<std::string>(&Client::declare_stream))
  ...
  py::class_<CallbackHandler, std::unique_ptr<CallbackHandler>>(m, "PyCallbckHandler")
    .def_static("set_event_handler",
                [](std::function<void(const Types::Enumerator&)> handler) {
