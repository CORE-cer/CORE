...
std::string create_select_query(std::string strategy,
...
TEST_CASE("Select captures star correctly",
...
TEST_CASE("Select captures list_of_variables correctly",
  ...
  condition = vars.contains("A") && vars.contains("B") &&
              vars.contains("C") && vars.size() == 3;
  REQUIRE(condition);
