#include "core_server/internal/ceql/cel_formula/formula/visitors/formula_to_ndcea.hpp"
...
TEST_CASE("Basic Event Type", "[ValueToMathExpr]") {
  ...
  InternalCORECEA::NDCEA ndcea = visitor.current_cea;
}
}  // namespace COREFormulaToNDCEA
