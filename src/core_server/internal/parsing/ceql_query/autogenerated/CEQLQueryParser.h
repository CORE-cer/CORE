...
public:
  enum {
    ...
    RIGHT_CURLY_BRACKET = 50, IDENTIFIER = 51, DOUBLE_LITERAL = 52, INTEGER_LITERAL = 53, 
    NUMERICAL_EXPONENT = 54, STRING_LITERAL = 55, SINGLE_LINE_COMMENT = 56, 
    MULTILINE_COMMENT = 57, SPACES = 58, UNEXPECTED_CHAR = 59, REGEX_START = 60, 
    REGEX_END = 61, REGEX_END_ESCAPED = 62, REGEX_PIPE = 63, REGEX_EXCLAMAITON = 64, 
    REGEX_L_CURLY = 65, REGEX_R_CURLY = 66, REGEX_L_PAR = 67, REGEX_R_PAR = 68, 
    REGEX_COMMA = 69, REGEX_QUESTION = 70, REGEX_PLUS = 71, REGEX_STAR = 72, 
    REGEX_HAT = 73, REGEX_HYPHEN = 74, REGEX_L_BRACK = 75, REGEX_R_BRACK = 76, 
    REGEX_BACKSLASH = 77, REGEX_ALPHA = 78, REGEX_DOT = 79, REGEX_DOUBLED_DOT = 80, 
    UNRECOGNIZED = 81, REGEX_DECIMAL_DIGIT = 82, REGEX_NOT_DECIMAL_DIGIT = 83, 
    REGEX_WHITESPACE = 84, REGEX_NOT_WHITESPACE = 85, REGEX_ALPHANUMERIC = 86, 
    REGEX_NOT_ALPHANUMERIC = 87, REGEX_DIGIT = 88
  };
