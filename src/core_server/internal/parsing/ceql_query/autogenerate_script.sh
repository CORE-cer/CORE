...
java -jar ~/.local/bin/antlr-4.12.0-complete.jar -o autogenerated -no-listener -visitor -Dlanguage=Cpp CEQLQueryLexer.g4
java -jar ~/.local/bin/antlr-4.12.0-complete.jar -o autogenerated -no-listener -visitor -Dlanguage=Cpp CEQLQueryParser.g4
echo -e "${GREEN}Finishing the auto-generation of CEQLQuery successfully.$NORMAL_OUTPUT"
