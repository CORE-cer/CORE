...
java -jar "$ANTLR_JAR" -o autogenerated -no-listener -visitor -Dlanguage=Cpp CEQLQueryLexer.g4
java -jar "$ANTLR_JAR" -o autogenerated -no-listener -visitor -Dlanguage=Cpp CEQLQueryParser.g4
