...
class PredicateVisitor : public CEQL_QUERYBaseVisitor {
 private:
 ...
 public:
  ...
  virtual std::any visitNot_predicate(
      CEQL_QUERYParser::Not_predicateContext* ctx) override {
    visit(ctx->predicate());
  ...
  virtual std::any visitInequality_predicate(
      CEQL_QUERYParser::Inequality_predicateContext* ctx) override {
  ...
  virtual std::any visitEquality_string_predicate(
      CEQL_QUERYParser::Equality_string_predicateContext* ctx) override {
  ...
  virtual std::any visitAnd_predicate(
      CEQL_QUERYParser::And_predicateContext* ctx) override {
  ...
  virtual std::any visitOr_predicate(
      CEQL_QUERYParser::Or_predicateContext* ctx) override {
    std::vector<std::unique_ptr<Predicate>> predicates;
    visit(ctx->predicate()[0]);
    predicates.push_back(std::move(predicate));
    visit(ctx->predicate()[1]);
  ...
  virtual std::any visitRegex_predicate(
      CEQL_QUERYParser::Regex_predicateContext* ctx) override {
  ...
  virtual std::any visitIn_predicate(
      CEQL_QUERYParser::In_predicateContext* ctx) override {
