...
java -jar "$ANTLR_JAR" -o autogenerated -no-listener -visitor -Dlanguage=Cpp OptionDeclarationLexer.g4
java -jar "$ANTLR_JAR" -o autogenerated -no-listener -visitor -Dlanguage=Cpp OptionDeclarationParser.g4
