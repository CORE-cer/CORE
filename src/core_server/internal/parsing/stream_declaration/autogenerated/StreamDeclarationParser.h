...
public:
  enum {
    ...
    RIGHT_CURLY_BRACKET = 55, COLON = 56, IDENTIFIER = 57, FLOAT_LITERAL = 58, 
    INTEGER_LITERAL = 59, NUMERICAL_EXPONENT = 60, STRING_LITERAL = 61, 
    REGEXP = 62, SINGLE_LINE_COMMENT = 63, MULTILINE_COMMENT = 64, SPACES = 65, 
    UNEXPECTED_CHAR = 66
  };
