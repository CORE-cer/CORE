#!/bin/bash
    ...
    java -jar ~/.local/bin/antlr-4.12.0-complete.jar -o autogenerated -no-listener -visitor -Dlanguage=Cpp STREAM_DECLARATION.g4
    echo -e "${GREEN}Fishing the auto-generation of STREAM_DECLARATION successfully.$NORMAL_OUTPUT"
