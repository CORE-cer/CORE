...
#include "autogenerated/StreamDeclarationParserBaseVisitor.h"
...
class Parser {
 public:
  static Types::StreamInfo parse_stream(std::string stream) {
    ...
    Types::StreamInfo stream_created = stream_visitor.get_parsed_stream();
